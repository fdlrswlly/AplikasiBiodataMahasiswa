...
Public Class CrystalReportMia
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AplikasiBiodataMahasiswa.CrystalReportMia.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportMia
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportMia = New CrystalReportMia()
        rpt.Site = Me.Site
        Return rpt
    End Function
